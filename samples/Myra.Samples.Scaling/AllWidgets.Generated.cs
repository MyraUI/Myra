/* Generated by MyraPad at 9/10/2026 9:42:06 AM */
using Myra;
...
namespace Myra.Samples
{
	partial class AllWidgets: VerticalStackPanel
	{
		private void BuildUI()
		{
			...
			_menuItemOpenFile.Image = MyraAssets.LoadImage("icon-folder");
			...
			_menuItemSaveFile.Image = MyraAssets.LoadImage("icon-folder-new");
			...
			_imageSaveFile.Renderable = MyraAssets.LoadImage("icon-star");
			...
			_imageOpenFile.Renderable = MyraAssets.LoadImage("icon-star");
			...
			_imageChooseFolder.Renderable = MyraAssets.LoadImage("icon-star");
			...
			image1.Renderable = MyraAssets.LoadImage("icon-star-outline");
			...
			_combo = new ComboView();
			_combo.Width = 200;
			_combo.Id = "_combo";
			Grid.SetColumn(_combo, 1);
			Grid.SetRow(_combo, 7);
			Grid.SetColumnSpan(_combo, 2);
			_combo.Widgets.Add(label12);
			_combo.Widgets.Add(label13);
			_combo.Widgets.Add(label14);
		...
		private MenuItem _menuItemOpenFile;
		private MenuItem _menuItemSaveFile;
		private MenuItem _menuItemChooseFolder;
		private MenuItem _menuItemChooseColor;
		...
		private Image _imageSaveFile;
		private Button _buttonSaveFile;
		private TextBox _textSaveFile;
		private Image _imageOpenFile;
		private Button _buttonOpenFile;
		private TextBox _textOpenFile;
		private Image _imageChooseFolder;
		private Button _buttonChooseFolder;
		private TextBox _textChooseFolder;
		private Label _textButtonLabel;
		private Button _buttonChooseColor;
		private Button _imageButton;
		private ComboView _combo;
